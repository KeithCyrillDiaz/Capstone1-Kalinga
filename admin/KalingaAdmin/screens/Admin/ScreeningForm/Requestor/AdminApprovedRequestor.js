...
const AdminApprovedDonor = ({route}) => {
  ...
  const remainingText = ` ${name} as a requestor. An email has been sent to notify them of their approval. Thank you for your diligence and dedication in the approval process.`;
