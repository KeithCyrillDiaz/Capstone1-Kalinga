...
const AppointmentDecline = () => {
    ...
    const FirstParagraph = 'The appointment has been successfully declined, and the user will receive a notification about its status.'
      ...
      <SafeAreaView style = {styles.SafeArea}>
          ...
          >
              <View style = {styles.container}>
                ...
                <AntDesign name="closesquare" size={200} color="#E60965" /></View>
