...
const AdminDeclinedDonor = ({route}) => {
  ...
  const remainingText = ` ${name} as a donor. An email has been sent to notify them of their rejection. Thank you for your diligence and dedication in the approval process.`;
