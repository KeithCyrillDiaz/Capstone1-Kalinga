    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        try {
          ...
          const response = await axios.get(`${WebHost}/kalinga/getTotalCompleteRequestPerMonth`, {
            params: {
          ...
          const Declineresponse = await axios.get(`${WebHost}/kalinga/getTotalDeclineRequestPerMonth`, {
            params: {
              selectedMonth: monthValue,
              selectedYear: parseInt(selectedYear),
            }
