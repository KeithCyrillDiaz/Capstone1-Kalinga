          ...
          <div>
            ...
            <div>
              <div
                ...
                className={`flex items-center pl-10 cursor-pointer w-full rounded-2xl py-2 ${
              ...
              >
                ...
                <h1 className="ml-4 text-2xl text-neutral-primary">Reports</h1>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="48"
                  height="48"
        ...
        <div>
          ...
          viewBox="0 0 24 24">
            ...
            d="M19 19H5V8h14m-3-7v2H8V1H6v2H5c-1.11 0-2 .89-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-1V1m-1 11h-5v5h5z"/>
                ...
                <h1 className="ml-4 text-2xl text-neutral-primary">Appointments</h1>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="48"
                  height="48"
              ...
              {showIssuesDropdown && (
                <div className="p-2">
                  <NavLink
                    ...
                    className={`grid grid-flow-col-dense items-center justify-center cursor-pointer w-full rounded-2xl gap-x-8 py-2 mb-5 ${
                      isActiveRoute("donorAppointments")
                        ? "bg-secondary-default"
                        : " bg-transparent"
                    }`}
                  >
                  ...
                  <NavLink
                    ...
                    className={`grid grid-flow-col-dense items-center justify-center cursor-pointer w-full rounded-2xl gap-x-8 py-2 mb-5 ${
                      isActiveRoute("requestorAppointments")
                        ? "bg-secondary-default"
                        : " bg-transparent"
                    }`}
                  >
