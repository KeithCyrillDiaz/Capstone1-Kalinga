    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={400}>
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="totalCompleteDonations" fill={COLORS[0]} name="Total Complete Donations" />
          <Bar dataKey="totalDeclineDonations" fill={COLORS[1]} name="Total Decline Donations" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
