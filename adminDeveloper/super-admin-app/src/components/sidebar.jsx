      ...
      <section className="flex flex-col justify-between w-full h-full py-8 p-2 body-color">
        <div>
          ...
          <div>
            ...
            <div>
              <div
                onClick={() => setVerificationDropdownHeight(!verificationDropdownHeight)}
                className={`flex items-center cursor-pointer w-full rounded-t-2xl pt-2 pb-2 ${
                  verificationDropdownHeight ? "bg-secondary-default" : ""
                } `}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  className={`transform transition-transform duration-300 ${
                    verificationDropdownHeight ? "rotate-0" : "rotate-180"
                  }`}
                >
                  <path fill="#FFEECC" d="m7 10l5 5l5-5z" />
                </svg>
              </div>
              {verificationDropdownHeight && (
                <div className="p-2 w-full bg-secondary-default rounded-b-2xl pb-2 mb-2">
                  <NavLink
          ...
          <div className="relative">
                ...
                >
                  ...
                  <path 
                  fill="#FFEECC"
                  d="M230.92 212c-15.23-26.33-38.7-45.21-66.09-54.16a72 72 0 1 0-73.66 0c-27.39 8.94-50.86 27.82-66.09 54.16a8 8 0 1 0 13.85 8c18.84-32.56 52.14-52 89.07-52s70.23 19.44 89.07 52a8 8 0 1 0 13.85-8M72 96a56 56 0 1 1 56 56a56.06 56.06 0 0 1-56-56" clip-rule="evenodd"/></svg>
                  <h1 className="ml-4 mr-4 text-2xl text-neutral-primary">
                    Issue
                  </h1>
